...
public class Send_To_User_Activity extends AppCompatActivity {

    List<Model> modelList_sendtouser = new ArrayList<>();
    RecyclerView mRecyclerView;
    RecyclerView.LayoutManager layoutManager;
    Adapter_Send_To_User adapter;
    ...
    private void showData(String phonenumber) {
        ...
        Cursor cursor = new DatabaseHelp(this).readselectuserdata(phonenumber);
        ...
        adapter = new Adapter_Send_To_User(Send_To_User_Activity.this, modelList_sendtouser);
        mRecyclerView.setAdapter(adapter);
    }

    public void selectuser(int position) {
        selectuser_phonenumber = modelList_sendtouser.get(position).getPhonenum();
        Cursor cursor = new DatabaseHelp(this).readparticulardata(selectuser_phonenumber);
        while (cursor.moveToNext()) {
            ...
            new DatabaseHelp(this).insertTransferData(date, name, selectuser_name, transferamount, "Success");
            new DatabaseHelp(this).updateAmount(selectuser_phonenumber, Dselectuser_remainingamount.toString());
            calculateAmount();
            Toast.makeText(this, "Transaction Successful!", Toast.LENGTH_LONG).show();
            startActivity(new Intent(Send_To_User_Activity.this, User_List_Activity.class));
            finish();
        }
    }
    ...
    private void calculateAmount() {
        ...
        new DatabaseHelp(this).updateAmount(phonenumber, remainingamount);
    }

    @Override
    public void onBackPressed() {
        AlertDialog.Builder builder_exitbutton = new AlertDialog.Builder(Send_To_User_Activity.this);
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new DatabaseHelp(Send_To_User_Activity.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
                        Toast.makeText(Send_To_User_Activity.this, "Transaction Cancelled!", Toast.LENGTH_LONG).show();
                        startActivity(new Intent(Send_To_User_Activity.this, User_List_Activity.class));
                        finish();
                    }
