...
public class User_Data extends AppCompatActivity {
    ...
    private void showData(String phonenumber) {
        Cursor cursor = new DatabaseHelp(this).readparticulardata(phonenumber);
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mAmount.getText().toString().isEmpty()) {
                    ...
                    Intent intent = new Intent(User_Data.this, Send_To_User_Activity.class);
        ...
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        new DatabaseHelp(User_Data.this).insertTransferData(date, name.getText().toString(), "Not selected", "0", "Failed");
