...
public class History_Transfer extends AppCompatActivity {
    ...
    private void showData() {
        ...
        Cursor cursor = new DatabaseHelp(this).readtransferdata();
        ...
        adapter = new History_Adapter(History_Transfer.this, modelList_historylist);
